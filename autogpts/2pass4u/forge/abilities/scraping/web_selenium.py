...
async def search_internet_with_selenium(agent, task_id: str, input: str, question: str = "") -> str:
    ...
    driver = None
    try:
        driver = open_page_in_browser(input)

        text = scrape_text_with_selenium(driver)
        links = scrape_links_with_selenium(driver, input)
        ...
        # Joining text and links together as one string
        response =  f"{text}\n\nLinks: {' '.join(links)}"
